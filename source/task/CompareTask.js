    ...
    compareEntity(entity, entitySettings, buildConfiguration, parameters)
    {
        ...
        const promise = co(function *()
        {
            ...
            for (const width of widths)
            {
                ...
                compare.referenceUrl = urls.normalizePathSeparators(compare.referenceFile.replace(scope._pathesConfiguration.sites, ''));
                compare.testUrl = urls.normalizePathSeparators(compare.testFile.replace(scope._pathesConfiguration.sites, ''));
                compare.diffFUrl = urls.normalizePathSeparators(compare.diffFile.replace(scope._pathesConfiguration.sites, ''));
